...
# --> DESCRIPTION
# It is a script that tries to update an existing AI Engine model to the MaaS. Otherwise, in case it doesn't exist, it
# is created.
...
# --> CODE                            
curl -X POST http://${maas_api_hostname}/api/models/update_or_create/ \
